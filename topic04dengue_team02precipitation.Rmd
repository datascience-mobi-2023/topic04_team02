...
for(year in 2006:2020)
{
  ...
  sum_data = cbind(as.data.frame(apply(subset_data1, 1, sum)), 
                    as.data.frame(apply(subset_data2, 1, sum)),
                    as.data.frame(apply(subset_data3, 1, sum)))
...
colnames(Precipitation_seasons) = c("Districts_names", "P_FebApr", "P_MaiOct", "P_NovJan")
```
...
colnames(Incidence_seasons) = c("Districts_names", "I_FebApr", "I_MaiOct", "I_NovJan")
```
