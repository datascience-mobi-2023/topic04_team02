...
```{r}
provinces_north = province_names[38:46,]
provinces_northeastern = province_names[19:37, ]
provinces_central = province_names[c(1:18,47:62), ]
provinces_south = province_names[63:76, ]
```
...
provinces_north_rows = province_numbers[38:46, 3]
provinces_northeastern_rows = province_numbers[19:37, 3]
provinces_central_rows = province_numbers[c(1:18,47:62), 3]
provinces_south_rows = province_numbers[63:76, 3]
```
