...
Precipitation[which(Precipitation[,1] == "Nong Khai"), 4:183] = (area_Nong_Khai * Precipitation[which(Dengue_2012[,1] == "Nong Khai"), 4:183] + area_Bungkan * Precipitation[which(Precipitation[,1] == "Bungkan"), 4:183])/(area_Bungkan + area_Nong_Khai) #add Bungkan and Nong Khai row together and display in Nong Khai row
...
```{r}
Dengue_2011[which(Dengue_2012[,1] == "Nong Khai"), 2:14] = Dengue_2011[which(Dengue_2012[,1] == "Nong Khai"), 2:14] + Dengue_2011[which(Dengue_2011[,1] == "Bungkan"), 2:14] #add Bungkan and Nong Khai row together and display in Nong Khai row
...
***Merge Bungkan and Nong Khai***
```{r}
Dengue_2012[which(Dengue_2012[,1] == "Nong Khai"), 2:14] = Dengue_2012[which(Dengue_2012[,1] == "Nong Khai"), 2:14] + Dengue_2012[which(Dengue_2012[,1] == "Bungkan"), 2:14] #add Bungkan and Nong Khai row together and display in Nong Khai row
...
Dengue_2012 = Dengue_2012[, colnames(Dengue_2011)] #sort dengue table
```
...
```{r}
Dengue_2013[which(Dengue_2013[,1] == "Nong Khai"), 2:14] = Dengue_2013[which(Dengue_2013[,1] == "Nong Khai"), 2:14] + Dengue_2013[which(Dengue_2013[,1] == "Bungkan"), 2:14] #add Bungkan and Nong Khai row together and display in Nong Khai row
...
Dengue_2013 = Dengue_2013[, colnames(Dengue_2011)] #sort dengue table
```
...
```{r}
Dengue_2014[which(Dengue_2014[,1] == "Nong Khai"), 2:14] = Dengue_2014[which(Dengue_2014[,1] == "Nong Khai"), 2:14] + Dengue_2014[which(Dengue_2014[,1] == "Bungkan"), 2:14] #add Bungkan and Nong Khai row together and display in Nong Khai row
...
Dengue_2014 = Dengue_2014[, colnames(Dengue_2011)] #sort dengue table
```
...
```{r}
Dengue_2015[which(Dengue_2015[,1] == "Nong Khai"), 2:14] = Dengue_2015[which(Dengue_2015[,1] == "Nong Khai"), 2:14] + Dengue_2015[which(Dengue_2015[,1] == "Bungkan"), 2:14] #add Bungkan and Nong Khai row together and display in Nong Khai row
...
Dengue_2015 = Dengue_2015[, colnames(Dengue_2011)] #sort dengue table
```
...
```{r}
Dengue_2016[which(Dengue_2016[,1] == "Nong Khai"), 2:14] = Dengue_2016[which(Dengue_2016[,1] == "Nong Khai"), 2:14] + Dengue_2016[which(Dengue_2016[,1] == "Bungkan"), 2:14] #add Bungkan and Nong Khai row together and display in Nong Khai row
...
Dengue_2016 = Dengue_2016[, colnames(Dengue_2011)] #sort dengue table
```
...
```{r}
Dengue_2017[which(Dengue_2012[,1] == "Nong Khai"), 2:14] = Dengue_2017[which(Dengue_2017[,1] == "Nong Khai"), 2:14] + Dengue_2017[which(Dengue_2017[,1] == "Bungkan"), 2:14] #add Bungkan and Nong Khai row together and display in Nong Khai row
