...
```{r}
<<<<<<< Updated upstream
lag_Dengue_combined = Dengue_combined[,-4] #remove January 2006
colnames(lag_Dengue_combined)[4:182] = colnames(Dengue_combined)[4:182] #move month name one column up
=======
...
```{r}
<<<<<<< Updated upstream
lag_Incidence_combined = Incidence_combined[,-4] #remove January 2006
colnames(lag_Incidence_combined)[4:182] = colnames(Incidence_combined)[4:182] #move month name one column up
=======
