...
### Total dengue cases north 
```{r}
sum2006_north <- data.frame(t(apply(Dengue_2006[38:46,4:15], 2,sum))) 
sum2007_north <- data.frame(t(apply(Dengue_2007[38:46,4:15], 2,sum)))
sum2008_north <- data.frame(t(apply(Dengue_2008[38:46,4:15], 2,sum))) 
sum2009_north <- data.frame(t(apply(Dengue_2009[38:46,4:15], 2,sum)))
sum2010_north <- data.frame(t(apply(Dengue_2010[38:46,4:15], 2,sum))) 
sum2011_north <- data.frame(t(apply(Dengue_2011[38:46,4:15], 2,sum)))
sum2012_north <- data.frame(t(apply(Dengue_2012[38:46,4:15], 2,sum))) 
sum2013_north <- data.frame(t(apply(Dengue_2013[38:46,4:15], 2,sum)))
sum2014_north <- data.frame(t(apply(Dengue_2014[38:46,4:15], 2,sum))) 
sum2015_north <- data.frame(t(apply(Dengue_2015[38:46,4:15], 2,sum)))
sum2016_north <- data.frame(t(apply(Dengue_2016[38:46,4:15], 2,sum))) 
sum2017_north <- data.frame(t(apply(Dengue_2017[38:46,4:15], 2,sum)))
sum2018_north <- data.frame(t(apply(Dengue_2018[38:46,4:15], 2,sum))) 
sum2019_north <- data.frame(t(apply(Dengue_2019[38:46,4:15], 2,sum)))
sum2020_north <- data.frame(t(apply(Dengue_2020[38:46,4:15], 2,sum)))
...
### Total dengue cases northeastern
```{r}
sum2006_northeastern <- data.frame(t(apply(Dengue_2006[19:37,4:15], 2,sum))) 
sum2007_northeastern <- data.frame(t(apply(Dengue_2007[19:37,4:15], 2,sum))) 
sum2008_northeastern <- data.frame(t(apply(Dengue_2008[19:37,4:15], 2,sum))) 
sum2009_northeastern <- data.frame(t(apply(Dengue_2009[19:37,4:15], 2,sum))) 
sum2010_northeastern <- data.frame(t(apply(Dengue_2010[19:37,4:15], 2,sum))) 
sum2011_northeastern <- data.frame(t(apply(Dengue_2011[19:37,4:15], 2,sum))) 
sum2012_northeastern <- data.frame(t(apply(Dengue_2012[19:37,4:15], 2,sum))) 
sum2013_northeastern <- data.frame(t(apply(Dengue_2013[19:37,4:15], 2,sum))) 
sum2014_northeastern <- data.frame(t(apply(Dengue_2014[19:37,4:15], 2,sum))) 
sum2015_northeastern <- data.frame(t(apply(Dengue_2015[19:37,4:15], 2,sum))) 
sum2016_northeastern <- data.frame(t(apply(Dengue_2016[19:37,4:15], 2,sum))) 
sum2017_northeastern <- data.frame(t(apply(Dengue_2017[19:37,4:15], 2,sum))) 
sum2018_northeastern <- data.frame(t(apply(Dengue_2018[19:37,4:15], 2,sum))) 
sum2019_northeastern <- data.frame(t(apply(Dengue_2019[19:37,4:15], 2,sum))) 
sum2020_northeastern <- data.frame(t(apply(Dengue_2020[19:37,4:15], 2,sum))) 

Dengue_Northeast = rbind(sum2006_northeastern, sum2007_northeastern, sum2008_northeastern, sum2009_northeastern, sum2010_northeastern, sum2011_northeastern, sum2012_northeastern, sum2013_northeastern, sum2014_northeastern, sum2015_northeastern, sum2016_northeastern, sum2017_northeastern, sum2018_northeastern, sum2019_northeastern, sum2020_northeastern) 
rownames(Dengue_Northeast) = colnames(Population)[3:17]
```

### Total dengue cases central
```{r}
sum2006_central <- data.frame(t(apply(Dengue_2006[1:18,4:15], 2,sum))+t(apply(Dengue_2006[47:62,4:15], 2,sum)))
sum2007_central <- data.frame(t(apply(Dengue_2007[1:18,4:15], 2,sum))+t(apply(Dengue_2007[47:62,4:15], 2,sum)))
sum2008_central <- data.frame(t(apply(Dengue_2008[1:18,4:15], 2,sum))+t(apply(Dengue_2008[47:62,4:15], 2,sum)))
sum2009_central <- data.frame(t(apply(Dengue_2009[1:18,4:15], 2,sum))+t(apply(Dengue_2009[47:62,4:15], 2,sum)))
sum2010_central <- data.frame(t(apply(Dengue_2010[1:18,4:15], 2,sum))+t(apply(Dengue_2010[47:62,4:15], 2,sum)))
sum2011_central <- data.frame(t(apply(Dengue_2011[1:18,4:15], 2,sum))+t(apply(Dengue_2011[47:62,4:15], 2,sum)))
sum2012_central <- data.frame(t(apply(Dengue_2012[1:18,4:15], 2,sum))+t(apply(Dengue_2012[47:62,4:15], 2,sum)))
sum2013_central <- data.frame(t(apply(Dengue_2013[1:18,4:15], 2,sum))+t(apply(Dengue_2013[47:62,4:15], 2,sum)))
sum2014_central <- data.frame(t(apply(Dengue_2014[1:18,4:15], 2,sum))+t(apply(Dengue_2014[47:62,4:15], 2,sum)))
sum2015_central <- data.frame(t(apply(Dengue_2015[1:18,4:15], 2,sum))+t(apply(Dengue_2015[47:62,4:15], 2,sum)))
sum2016_central <- data.frame(t(apply(Dengue_2016[1:18,4:15], 2,sum))+t(apply(Dengue_2016[47:62,4:15], 2,sum)))
sum2017_central <- data.frame(t(apply(Dengue_2017[1:18,4:15], 2,sum))+t(apply(Dengue_2017[47:62,4:15], 2,sum)))
sum2018_central <- data.frame(t(apply(Dengue_2018[1:18,4:15], 2,sum))+t(apply(Dengue_2018[47:62,4:15], 2,sum)))
sum2019_central <- data.frame(t(apply(Dengue_2019[1:18,4:15], 2,sum))+t(apply(Dengue_2019[47:62,4:15], 2,sum)))
sum2020_central <- data.frame(t(apply(Dengue_2020[1:18,4:15], 2,sum))+t(apply(Dengue_2020[47:62,4:15], 2,sum)))
...
### Total dengue cases south
```{r}
sum2006_south <- data.frame(t(apply(Dengue_2006[63:76,4:15], 2,sum)))
sum2007_south <- data.frame(t(apply(Dengue_2007[63:76,4:15], 2,sum)))
sum2008_south <- data.frame(t(apply(Dengue_2008[63:76,4:15], 2,sum)))
sum2009_south <- data.frame(t(apply(Dengue_2009[63:76,4:15], 2,sum)))
sum2010_south <- data.frame(t(apply(Dengue_2010[63:76,4:15], 2,sum)))
sum2011_south <- data.frame(t(apply(Dengue_2011[63:76,4:15], 2,sum)))
sum2012_south <- data.frame(t(apply(Dengue_2012[63:76,4:15], 2,sum)))
sum2013_south <- data.frame(t(apply(Dengue_2013[63:76,4:15], 2,sum)))
sum2014_south <- data.frame(t(apply(Dengue_2014[63:76,4:15], 2,sum)))
sum2015_south <- data.frame(t(apply(Dengue_2015[63:76,4:15], 2,sum)))
sum2016_south <- data.frame(t(apply(Dengue_2016[63:76,4:15], 2,sum)))
sum2017_south <- data.frame(t(apply(Dengue_2017[63:76,4:15], 2,sum)))
sum2018_south <- data.frame(t(apply(Dengue_2018[63:76,4:15], 2,sum)))
sum2019_south <- data.frame(t(apply(Dengue_2019[63:76,4:15], 2,sum)))
sum2020_south <- data.frame(t(apply(Dengue_2020[63:76,4:15], 2,sum)))
...
### Norming total dengue data according to the regional population data
...
***Normed dengue cases per region***
```{r}
Incidence_North = apply(Dengue_North, 2, function(x){(x/ t(Population_North)) * 100000}) 
rownames(Incidence_North) = colnames(Population)[3:17]

Incidence_Northeast = apply(Dengue_Northeast, 2, function(x){(x/ t(Population_Northeast)) * 100000}) 
rownames(Incidence_Northeast) = colnames(Population)[3:17]

Incidence_Central = apply(Dengue_Central, 2, function(x){(x/ t(Population_Central)) * 100000}) 
rownames(Incidence_Central) = colnames(Population)[3:17]

Incidence_South = apply(Dengue_South, 2, function(x){(x/ t(Population_South)) * 100000}) 
