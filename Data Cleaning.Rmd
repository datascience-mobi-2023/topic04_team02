...
```{r}
library(readxl)
Precipitation <- as.data.frame(read_excel("Data/ClimateData_2006_2020.xlsx", sheet = "era5_tp_2006_2020_thailand_monm"))
```

## Dengue data
```{r}
library(readxl)
Dengue_2006 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2006"))
Dengue_2007 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2007"))
Dengue_2008 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2008"))
Dengue_2009 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2009"))
Dengue_2010 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2010"))
Dengue_2011 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2011"))
Dengue_2012 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2012"))
Dengue_2013 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2013"))
Dengue_2014 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2014"))
Dengue_2015 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2015"))
Dengue_2016 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2016"))
Dengue_2017 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2017"))
Dengue_2018 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2018"))
Dengue_2019 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2019"))
Dengue_2020 <- as.data.frame(read_excel("Data/dengue_data.xlsx", sheet = "2020"))
...
## Population Data
```{r}
Population <- as.data.frame(read_excel("Data/population.xlsx", sheet = "Tabelle1"))
```
...
```{r}
library(readxl)
province_numbers <- as.data.frame(read_excel("Data/province_numbers.xlsx"))
...
```{r}
library(readxl)
area <- as.data.frame(read_excel("Data/area_data.xlsx"))
```
...
for (year in 2006:2020) 
{
  ...
  assign(paste0("Dengue_", year, "c"), data)
}
```
...
colnames(Precipitation_2006)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2007)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2008)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2009)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2010)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2011)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2012)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2013)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2014)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2015)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2016)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2017)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2018)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2019)[5:16] = colnames(Dengue_2020)[3:14]
colnames(Precipitation_2020)[5:16] = colnames(Dengue_2020)[3:14]
```

### Area Data

***convert sq. km2 into sp. m2***
```{r}
area[,2] = area[,2]*1000
```
...
***Merge Bungkan and Nong Khai***
```{r}
area[which(area[,1] == "Nong Khai"), 2] = area[which(area[,1] == "Nong Khai"), 2] + area[which(area[,1] == "Bueng Kan"), 2] #add Bungkan and Nong Khai row together and display in Nong Khai row

area = area[-which(area[,1] == "Bueng Kan"), ] #delete Bungkan row

rownames(area) = 1:76 # rename the rows since one row was deleted
```
...
for (x in 1:76)
  area[x,] = area_1[which(province_numbers[x,2] == area_1[,1]),]

area = cbind(province_numbers$Number, area)
colnames(area)[1] = "Code number"
```
...
colnames(Dengue_2018)[9] = "June" #Correcting the colnames
colnames(Dengue_2018)[10] = "July"
colnames(Dengue_2018)[12] = "Sept"
```
...
colnames(Dengue_2019)[9] = "June" #Correcting the colnames
colnames(Dengue_2019)[10] = "July"
colnames(Dengue_2019)[12] = "Sept"
```
...
colnames(Dengue_2020)[9] = "June" #Correcting the colnames
colnames(Dengue_2020)[10] = "July"
colnames(Dengue_2020)[12] = "Sept"
```
...
{
  data = get(paste0("Dengue_", year))
  population = Population[[as.character(year)]]
  province_numbers_subset = province_numbers[, 3:2]
  incidence = apply(data[, 3:15], 2, function(x) {x / population * 100000})
  incidence = cbind(province_numbers_subset, incidence)
  assign(paste0("Incidence_", year), incidence)
}
```

## Combine all years of Dengue Data into one big dataframe
### Total Dengue cases

```{r}
Dengue_combined = cbind(Dengue_2006[,-3], Dengue_2007[4:15], Dengue_2008[4:15], Dengue_2009[4:15], Dengue_2010[4:15], Dengue_2011[4:15], Dengue_2012[4:15], Dengue_2013[4:15], Dengue_2014[4:15], Dengue_2015[4:15], Dengue_2016[4:15], Dengue_2017[4:15], Dengue_2018[4:15], Dengue_2019[4:15], Dengue_2020[4:15])

colnames(Dengue_combined)[3:182] = colnames(Precipitation)[5:184]
colnames(Dengue_combined)[2] = "Districts_names"
```

### Incidence
```{r}
Incidence_combined = cbind(Incidence_2006[,-3], Incidence_2007[4:15], Incidence_2008[4:15], Incidence_2008[4:15], Incidence_2010[4:15], Incidence_2011[4:15], Incidence_2012[4:15], Incidence_2013[4:15], Incidence_2014[4:15], Incidence_2015[4:15], Incidence_2016[4:15], Incidence_2017[4:15], Incidence_2018[4:15], Incidence_2019[4:15], Incidence_2020[4:15])

colnames(Incidence_combined)[3:182] = colnames(Precipitation)[5:184]
colnames(Incidence_combined)[2] = "Districts_names"
```

## Lag data
After periods of rain, it takes a while until the Aeges mosquitos breed and proliferate, so there is a time lag between the rainfall and the dengue cases. This will be taken into consideration by moving the Dengue cases up one month.

### For Dengue data
```{r}
lag_Dengue_combined = Dengue_combined[,-3] #remove January 2006
colnames(lag_Dengue_combined)[3:181] = colnames(Dengue_combined)[3:181] #move month name one column up
```

### For Incidence data
```{r}
lag_Incidence_combined = Incidence_combined[,-3] #remove January 2006
colnames(lag_Incidence_combined)[3:181] = colnames(Incidence_combined)[3:181] #move month name one column up
```

## Incidence for 5 years
```{r}
Incidence_06_10 = cbind(province_numbers[,2], apply(as.data.frame(sapply(2006:2010, function(year) get(paste0("Incidence_", year))[, 3])), 1, sum))
colnames(Incidence_06_10) = c("Districts_names", "Incidence")

Incidence_11_15 = cbind(province_numbers[,2], apply(as.data.frame(sapply(2011:2015, function(year) get(paste0("Incidence_", year))[, 3])), 1, sum))
colnames(Incidence_11_15) = c("Districts_names", "Incidence")

Incidence_16_20 = cbind(province_numbers[,2], apply(as.data.frame(sapply(2016:2020, function(year) get(paste0("Incidence_", year))[, 3])), 1, sum))
colnames(Incidence_16_20) = c("Districts_names", "Incidence")
```

## Precipitation for 5 years
```{r}
# 2006-2010
Prec_06_10 = as.data.frame(sapply(2006:2010, function(year) as.data.frame(apply(get(paste0("Precipitation_", year))[, 5:16], 1, sum))))

Precipitation_06_10 = cbind(province_numbers[, 2], as.data.frame(apply(Prec_06_10, 1, sum)))

colnames(Precipitation_06_10) = c("district_names", "Prec 06-10")

# 2011-2015
Prec_11_15 = as.data.frame(sapply(2011:2015, function(year) as.data.frame(apply(get(paste0("Precipitation_", year))[, 5:16], 1, sum))))

Precipitation_11_15 = cbind(province_numbers[, 2], as.data.frame(apply(Prec_11_15, 1, sum)))

colnames(Precipitation_11_15) = c("district_names", "Prec 11-15")

# 2016-2020
Prec_16_20 = as.data.frame(sapply(2016:2020, function(year) as.data.frame(apply(get(paste0("Precipitation_", year))[, 5:16], 1, sum))))

Precipitation_16_20 = cbind(province_numbers[, 2], as.data.frame(apply(Prec_16_20, 1, sum)))

colnames(Precipitation_16_20) = c("district_names", "Prec 16-20")
```

## Prec Inc Combi for 5 years
```{r}
Prec_Inc_06_20 = cbind(Precipitation_06_10, Precipitation_11_15[,2], Precipitation_16_20[,2], Incidence_06_10[,2], Incidence_11_15[,2], Incidence_16_20[,2])

colnames(Prec_Inc_06_20) = c("Districts_names", "Prec 06-10", "Prec 11-15", "Prec 16-20", "Inc 06-10", "Inc 11-15", "Inc 16-20")
```
...
## Total dengue cases per region 

### North total dengue cases 
```{r}
for (year in 2006:2020) {
  data = get(paste0("Dengue_", year))
  subset_data = data[38:46, 4:15]
  sum_data = data.frame(t(apply(subset_data, 2, sum)))
  assign(paste0("sum", year, "_north"), sum_data)
}

Dengue_North = rbind(sum2006_north, sum2007_north, sum2008_north, sum2009_north, sum2010_north, sum2011_north, sum2012_north, sum2013_north, sum2014_north, sum2015_north, sum2016_north, sum2017_north, sum2018_north, sum2019_north, sum2020_north) 
rownames(Dengue_North) = colnames(Population)[3:17]
```

### Northeastern total dengue cases 
```{r}
for (year in 2006:2020) {
  data = get(paste0("Dengue_", year))
  subset_data = data[19:37, 4:15]
  sum_data = data.frame(t(apply(subset_data, 2, sum)))
  assign(paste0("sum", year, "_northeast"), sum_data)
}

Dengue_Northeast = rbind(sum2006_northeast, sum2007_northeast, sum2008_northeast, sum2009_northeast, sum2010_northeast, sum2011_northeast, sum2012_northeast, sum2013_northeast, sum2014_northeast, sum2015_northeast, sum2016_northeast, sum2017_northeast, sum2018_northeast, sum2019_northeast, sum2020_northeast) 
rownames(Dengue_Northeast) = colnames(Population)[3:17]
```

### Central total dengue cases
```{r}
for (year in 2006:2020) {
  data = get(paste0("Dengue_", year))
  subset_data = data[c(1:18, 47:62), 4:15]
  sum_data = data.frame(t(apply(subset_data, 2, sum)))
  assign(paste0("sum", year, "_central"), sum_data)
}

Dengue_Central = rbind(sum2006_central, sum2007_central, sum2008_central, sum2009_central, sum2010_central, sum2011_central, sum2012_central, sum2013_central, sum2014_central, sum2015_central, sum2016_central, sum2017_central, sum2018_central, sum2019_central, sum2020_central) 
rownames(Dengue_Central) = colnames(Population)[3:17]
```

### South total dengue cases
```{r}
for (year in 2006:2020) {
  data = get(paste0("Dengue_", year))
  subset_data = data[63:76, 4:15]
  sum_data = data.frame(t(apply(subset_data, 2, sum)))
  assign(paste0("sum", year, "_south"), sum_data)
}

Dengue_South = rbind(sum2006_south, sum2007_south, sum2008_south, sum2009_south, sum2010_south, sum2011_south, sum2012_south, sum2013_south, sum2014_south, sum2015_south, sum2016_south, sum2017_south, sum2018_south, sum2019_south, sum2020_south) 
rownames(Dengue_South) = colnames(Population)[3:17]
```
...
```{r}
Population_North = data.frame(t(apply(Population[38:46, 3:17], 2, sum)))
colnames(Population_North) = colnames(Population)[3:17]

Population_Northeast = data.frame(t(apply(Population[19:37, 3:17], 2, sum)))
colnames(Population_Northeast) = colnames(Population)[3:17]

Population_Central = data.frame(t(apply(Population[c(1:18, 47:62), 3:17], 2, sum)))
colnames(Population_Central) = colnames(Population)[3:17]

Population_South = data.frame(t(apply(Population[63:76, 3:17], 2, sum)))
colnames(Population_South) = colnames(Population)[3:17]
```

### Incidence
```{r}
for (region in c("North", "Northeast", "Central", "South")) 
{
  dataD = get(paste0("Dengue_", region))
  dataP = get(paste0("Population_", region))
  assign(paste0("Incidence_", region), apply(dataD, 2, function(x){(x/ t(dataP)) * 100000}))
}

rownames(Incidence_North) = colnames(Population)[3:17]
rownames(Incidence_Northeast) = colnames(Population)[3:17]
rownames(Incidence_Central) = colnames(Population)[3:17]
rownames(Incidence_South) = colnames(Population)[3:17]
```

## Precipitation data per Region

### Area per Region
```{r}
Area_North = sum(area[38:46,3])
Area_Northeast = sum(area[19:37,3])
Area_Central = sum(area[c(1:18, 47:62),3])
Area_South = sum(area[63:76,3])
```

### North
```{r}
Precipitation_North = NULL

for(year in 2006:2020)
{
  data = get(paste0("Precipitation_", year))
  subset_data = data[38:46, 5:16]
  p_North = as.data.frame(t(apply(subset_data, 2, function(x){sum(x * area[38:46, 3]) / Area_North})))
  Precipitation_North = rbind(Precipitation_North, p_North)
}
...
for(year in 2006:2020)
{
  data = get(paste0("Precipitation_", year))
  subset_data = data[38:46, 5:16]
  pr_North = as.data.frame(t(apply(subset_data, 2, function(x){sum(x * area[38:46, 3]) / Area_North})))
  assign(paste0("sum", year, "_north_pr"), pr_North)
}

rownames(Precipitation_North) = colnames(Population)[3:17]
```

### Northeast
```{r}
Precipitation_Northeast = NULL

for(year in 2006:2020)
{
  data = get(paste0("Precipitation_", year))
  subset_data = data[19:37, 5:16]
  p_Northeast = as.data.frame(t(apply(subset_data, 2, function(x){sum(x * area[19:37, 3]) / Area_Northeast})))
  Precipitation_Northeast = rbind(Precipitation_Northeast, p_Northeast)
}
...
for(year in 2006:2020)
{
  data = get(paste0("Precipitation_", year))
  subset_data = data[19:37, 5:16]
  pr_Northeast = as.data.frame(t(apply(subset_data, 2, function(x){sum(x * area[19:37, 3]) / Area_Northeast})))
  assign(paste0("sum", year, "_northeast_pr"), pr_Northeast)
}

rownames(Precipitation_Northeast) = colnames(Population)[3:17]
```

### Central
```{r}
Precipitation_Central = NULL

for(year in 2006:2020)
{
  data = get(paste0("Precipitation_", year))
  subset_data = data[c(1:18, 47:62), 5:16]
  p_Central = as.data.frame(t(apply(subset_data, 2, function(x){sum(x * area[c(1:18, 47:62), 3]) /Area_Central})))
  Precipitation_Central = rbind(Precipitation_Central, p_Central)
}
...
for(year in 2006:2020)
{
  data = get(paste0("Precipitation_", year))
  subset_data = data[c(1:18, 47:62), 5:16]
  pr_Central = as.data.frame(t(apply(subset_data, 2, function(x){sum(x * area[c(1:18, 47:62), 3]) /Area_Central})))
  assign(paste0("sum", year, "_central_pr"), pr_Central)
}

rownames(Precipitation_Central) = colnames(Population)[3:17]
```

### South
```{r}
Precipitation_South = NULL

for(year in 2006:2020)
{
  data = get(paste0("Precipitation_", year))
  subset_data = data[63:76, 5:16]
  p_South = as.data.frame(t(apply(subset_data, 2, function(x){sum(x * area[63:76, 3]) / Area_South})))
  Precipitation_South = rbind(Precipitation_South, p_South)
}
...
for(year in 2006:2020)
{
  data = get(paste0("Precipitation_", year))
  subset_data = data[63:76, 5:16]
  pr_South = as.data.frame(t(apply(subset_data, 2, function(x){sum(x * area[63:76, 3]) / Area_South})))
  assign(paste0("sum", year, "_south_pr"), pr_South)
}

rownames(Precipitation_South) = colnames(Population)[3:17]
```
...
{
  data = get(paste0("Precipitation_", year))
  subset_data1 = data[,6:8]
  subset_data2 = data[,9:14]
  subset_data3 = data[,c(5, 15:16)]
  sum_data = cbind(as.data.frame(apply(subset_data1, 1, function(x) {sum(x) / 3})), 
                    as.data.frame(apply(subset_data2, 1, function(x) {sum(x) / 6})),
                    as.data.frame(apply(subset_data3, 1, function(x) {sum(x) / 3})))
  assign(paste0("Prec_seasons_", year), sum_data)
}

Precipitation_seasons = (Prec_seasons_2006 + Prec_seasons_2007 + Prec_seasons_2008 + Prec_seasons_2009 + Prec_seasons_2010 + Prec_seasons_2011 + Prec_seasons_2012 + Prec_seasons_2013 + Prec_seasons_2014 + Prec_seasons_2015 + Prec_seasons_2016 + Prec_seasons_2017 + Prec_seasons_2018 + Prec_seasons_2019 + Prec_seasons_2020) / 15 

Precipitation_seasons = cbind(Precipitation[,2], Precipitation_seasons)
colnames(Precipitation_seasons) = c("Districts_names", "P_FebApr", "P_MayOct", "P_NovJan")
```

***Remove useless variables***
```{r}
remove(Prec_seasons_2006, Prec_seasons_2007, Prec_seasons_2008, Prec_seasons_2009, Prec_seasons_2010, Prec_seasons_2011, Prec_seasons_2012, Prec_seasons_2013, Prec_seasons_2014, Prec_seasons_2015, Prec_seasons_2016, Prec_seasons_2017, Prec_seasons_2018, Prec_seasons_2019, Prec_seasons_2020)
```
...
for(year in 2006:2020)
{
  data = get(paste0("Incidence_", year))
  subset_data1 = data[,5:7]
  subset_data2 = data[,8:13]
  subset_data3 = data[,c(4, 14:15)]
  sum_data = cbind(as.data.frame(apply(subset_data1, 1, function(x) {sum(x) / 3})), 
                    as.data.frame(apply(subset_data2, 1, function(x) {sum(x) / 6})),
                    as.data.frame(apply(subset_data3, 1, function(x) {sum(x) / 3})))
  assign(paste0("Inc_seasons_", year), sum_data)
}

Incidence_seasons = (Inc_seasons_2006 + Inc_seasons_2007 + Inc_seasons_2008 + Inc_seasons_2009 + Inc_seasons_2010 + Inc_seasons_2011 + Inc_seasons_2012 + Inc_seasons_2013 + Inc_seasons_2014 + Inc_seasons_2015 + Inc_seasons_2016 + Inc_seasons_2017 + Inc_seasons_2018 + Inc_seasons_2019 + Inc_seasons_2020) / 15 

Incidence_seasons = cbind(Incidence_2006[,2], Incidence_seasons)
colnames(Incidence_seasons) = c("Districts_names", "I_FebApr", "I_MayOct", "I_NovJan")
```

***Remove useless variables***
```{r}
remove(Inc_seasons_2006, Inc_seasons_2007, Inc_seasons_2008, Inc_seasons_2009, Inc_seasons_2010, Inc_seasons_2011, Inc_seasons_2012, Inc_seasons_2013, Inc_seasons_2014, Inc_seasons_2015, Inc_seasons_2016, Inc_seasons_2017, Inc_seasons_2018, Inc_seasons_2019, Inc_seasons_2020)
```


# GAM data cleaning (monsoon)
...
```{r}
for (lag in 0:2) {
  assign(paste0("GAM_", lag), data.frame(NULL))
  
  for (month in 3:62) {
    data = cbind(monsoon_prec[ ,month],
                 get(paste0("monsoon_inc_", lag, "_lag"))[, month])
    
    colnames(data) = c("precipitation", "dengue")
    
    assign(paste0("GAM_", lag), rbind(get(paste0("GAM_", lag)), data))
  }
}
```
