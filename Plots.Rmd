...
<<<<<<< HEAD
incidence_plot <- plot(x = 1:180, y = c(Incidence_North[1,],Incidence_North[2,],Incidence_North[3,],Incidence_North[4,],Incidence_North[5,],Incidence_North[6,],Incidence_North[7,],Incidence_North[8,],Incidence_North[9,],Incidence_North[10,],Incidence_North[11,],Incidence_North[12,], Incidence_North[13,],Incidence_North[14,],Incidence_North[15,]), type = "l", pch = 20, col = "purple2", xlab = "month", ylab = "Incidences", main = "Incidences 2006-2020", ylim = c(0,170)); 
=======
...
>>>>>>> 2bb985e18c765fe885aa8e26e4b417b804667e59
...
<<<<<<< HEAD
precipitation_plot <- plot(x = 1:180, y = c(Precipitation_North[1,],Precipitation_North[2,],Precipitation_North[3,],Precipitation_North[4,],Precipitation_North[5,],Precipitation_North[6,],Precipitation_North[7,],Precipitation_North[8,],Precipitation_North[9,],Precipitation_North[10,],Precipitation_North[11,],Precipitation_North[12,], Precipitation_North[13,],Precipitation_North[14,],Precipitation_North[15,]), type = "l", pch = 20, col = "purple2", xlab = "month", ylab = "Precipitation", main = "Precipitation 2006-2020", ylim = c(0,600)); 
=======
