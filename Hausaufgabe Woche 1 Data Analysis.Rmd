...
```{r}
plot(x = colnames(Thailand_tp[,5:19]), y = Thailand_tp[1,5:19], type = "b", pch = 19, xlab = "year", ylab = "total percipitation", main = Thailand_tp[1,2]); lines(colnames(Thailand_tp[,5:19]), Thailand_tp[2,5:19], type = "b", pch = 19, col = "red")
```
