...
## Align province names, delete useless rows and add district numbers for all data sets
...
Dengue_2006c = Dengue_2006c[which((Dengue_2006[,1] %in% province_names[,1])), ]
rownames(Dengue_2006c) = c(1:76)
Dengue_2006c
```

***Addition of district numbers***
```{r}
...
```{r}
Dengue_2006c2 = cbind(Dengue_2006c
Dengue_2006c2
```
